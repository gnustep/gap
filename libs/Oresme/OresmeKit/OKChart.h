...
/**
   ...
   <p>[OKChart]s draw data is represented in [OKSeries]. Depending on the chart style, one or more series are supported or needed.
   </p>
   <p>Series may be managed by</p>
   <list>
   <item>addSeries</item>
   <item>removeSeriesAtIndex</item>
   <item>removeAllSeries</item>
   <item>seriesAtIndex</item>
   <item>seriesCount</item>
   </list>
   <strong>Drawing</strong>
   <p>An [OKChart] is a subclass of <code>NSView</code>, thus the final drawing happens in the drawRect.</p>
